...
is periodic 
%\\\quad\quad  \emph{i.e.}  $H$ has finite orbit.
...
%
%\vspace{6mm} \pause
%His result is based on theory of canonical heights for subvarieties of $\PP^N$. We can deduce from the proof of Hutz's theorem  a bound for $|HPrePer(\phi,K,e)|$ depending on
%\begin{itemize}
%\item $n$
%\item $e$
%\item $[K:\QQ]$
...
%\begin{frame}
%\frametitle{Tools}
%The theorem is based on the following three tools:\vspace{5mm}
%\begin{itemize}
